...
<head>
    ...
    <link rel="stylesheet" href="./css/entry_points.css">
            ...
            <main id="main" class="site-main clr">
                <div class="entrypoints">
                    <div class="heading">
                        <h1>Entry Points</h1>
                        <h2>AIRPORTS</h2>
                        <h3>persons holding eVisa will be allowed to enter into india only through the designated international airports(28) namely:</h3>
                    </div>
                    ...
                    <div class="heading">
                        <h2>SEAPORTS</h2>
                        <h3>eVisa facality is provided for entry at 5 major indian seaport for cruise tourists:</h3>
                    </div>

                    <div class="airport">
                        <div class="airportnames" style="display: flex; justify-content:space-around;width:100%">
                           <p>1.Delhi</p> 
                           <p>2.Delhi</p> 
                           <p>3.Delhi</p> 
                           <p>4.Delhi</p> 
