                                    ...
                                    <div data-elementor-type="wp-post" data-elementor-id="18" class="elementor elementor-18" data-elementor-settings="[]">
                                        <div class="elementor-inner">
                                            <div class="elementor-section-wrap">
                                                <section class="elementor-element elementor-element-28f4103 elementor-section-boxed elementor-section-height-default elementor-section-height-default elementor-section elementor-top-section" data-id="28f4103" data-element_type="section">
                                                                                ...
                                                                                <div class="htmega-tab-area htmega-tab-style-4">
                                                                                    ...
                                                                                    <div class="htmega-tab-nav htb-nav htmega-tab-menu-style-4" role="tablist">
                                                                                        <a class="htb-nav-link htb-active htb-show elementor-repeater-item-2edbcfe" href="#htmegatab-43f78fd1" data-toggle="htbtab" role="tab">Proof of
                                                                                            ...
                                                                                            Identity</a><a class="htb-nav-link  elementor-repeater-item-a5c5748" href="#htmegatab-43f78fd4" data-toggle="htbtab" role="tab">Proof of
                                                                                            Education / Non-ECR</a>
                                                                                    </div>

                                                                                    <div class="htmega-tab-content-area htb-tab-content">
                                                                                        <div class="htmega-single-tab htb-tab-pane htb-fade htb-active htb-show elementor-repeater-item-2edbcfe" id="htmegatab-43f78fd1" role="tabpanel">
                                                                                        ...
                                                                                        <div class="htmega-single-tab htb-tab-pane htb-fade  elementor-repeater-item-f1e8bb3" id="htmegatab-43f78fd2" role="tabpanel">
                                                                                            <div class="htmega-tab-content">
                                                                                                <ul class="doc-list">
                                                                                                    <li>Pan Card</li>
                                                                                                    <li>Aadhar Card</li>
                                                                                        ...
                                                                                        <div class="htmega-single-tab htb-tab-pane htb-fade  elementor-repeater-item-17c0219" id="htmegatab-43f78fd3" role="tabpanel">
                                                                                            <div class="htmega-tab-content">
                                                                                                <ul class="doc-list">
                                                                                                    <li>Pan Card</li>
                                                                                                    <li>Aadhar Card</li>
                                                                                        ...
                                                                                        <div class="htmega-single-tab htb-tab-pane htb-fade  elementor-repeater-item-a5c5748" id="htmegatab-43f78fd4" role="tabpanel">
                                                                                            <div class="htmega-tab-content">
                                                                                                <ul class="doc-list">
                                                                                                    <li>Matriculation
                                                                                                        Certificate</li>
